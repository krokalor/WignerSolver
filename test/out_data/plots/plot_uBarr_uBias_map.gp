...
set output 'uBarr_uBias_map.png'
...
set ylabel 'U_0 [eV]' # offset 0,-0.5
set xlabel 'U_{bias} [eV]}' # textcolor "black" # offset -0.5,0
...
# set cblabel "Current density range |max-min| [Acm^{-2}]" offset 2
set cblabel "Electron number [cm^{-2}]" offset 2
...
splot [0:0.15] [0:0.15] '../uBarr_uBias_map.out' u 2:1:5 with pm3d
