...
set xlabel "Iteracja"
set ylabel "Charakterystyka transportowa"  # Gęstość prądu [Acm^{-2}]
...
#     '../tr_char_100meV.csv' u 1:i w lp ls 1 title '100meV',\
#     '../tr_char_10meV.csv' u 1:i w lp ls 2 title '10meV',\
#     '../tr_char_0meV.csv' u 1:i w lp ls 3 title '0meV'
# plot '../tr_char_UDS2.csv' title columnhead(i) with lines lc rgb "white",\
#     '../tr_char_UDS2.csv' u 1:i w lp ls 1 title 'UDS2',\
#     '../tr_char_UDS3.csv' u 1:i w lp ls 2 title 'UDS3',\
#     '../tr_char_HDS22.csv' u 1:i w lp ls 3 title 'HDS22'
